...
export const INITIAL_CHAPTERS: Chapter[] = [
  // KANNADA
  { id: 'kan-1', subjectId: 'kannada', chapterNo: 1, title: 'ಯುದ್ಧ (Yuddha)', status: 'MASTERED', weakTag: false, notesCount: 1, questionsCount: 1 },
  { id: 'kan-2', subjectId: 'kannada', chapterNo: 2, title: 'ಶಬರಿ (Shabari)', status: 'REVISED', weakTag: false, notesCount: 1, questionsCount: 0 },
  { id: 'kan-3', subjectId: 'kannada', chapterNo: 3, title: 'ಭಾಗ್ಯಶಿಲ್ಪಿಗಳು (Bhagyashilpigalu)', status: 'PRACTISED', weakTag: false, notesCount: 1, questionsCount: 1 },
  { id: 'kan-4', subjectId: 'kannada', chapterNo: 4, title: 'ಲಂಡನ್ ನಗರ (London Nagara)', status: 'LEARNING', weakTag: true, notesCount: 0, questionsCount: 0 },
  { id: 'kan-5', subjectId: 'kannada', chapterNo: 5, title: 'ಸಂಕಲ್ಪ ಗೀತೆ (Sankalpa Geethe)', status: 'REVISED', weakTag: false, notesCount: 1, questionsCount: 0 },
  ...
  // MATHEMATICS
  { id: 'math-1', subjectId: 'math', chapterNo: 1, title: 'Real Numbers', status: 'MASTERED', weakTag: false, notesCount: 1, questionsCount: 2 },
  { id: 'math-2', subjectId: 'math', chapterNo: 2, title: 'Polynomials', status: 'MASTERED', weakTag: false, notesCount: 1, questionsCount: 1 },
  { id: 'math-3', subjectId: 'math', chapterNo: 3, title: 'Pair of Linear Equations', status: 'REVISED', weakTag: false, notesCount: 1, questionsCount: 1 },
  { id: 'math-4', subjectId: 'math', chapterNo: 4, title: 'Quadratic Equations', status: 'PRACTISED', weakTag: false, notesCount: 1, questionsCount: 1 },
  { id: 'math-5', subjectId: 'math', chapterNo: 5, title: 'Arithmetic Progressions', status: 'MASTERED', weakTag: false, notesCount: 1, questionsCount: 1 },
  { id: 'math-6', subjectId: 'math', chapterNo: 6, title: 'Triangles (Similarity & Theorems)', status: 'LEARNING', weakTag: true, notesCount: 1, questionsCount: 2 },
  { id: 'math-7', subjectId: 'math', chapterNo: 7, title: 'Coordinate Geometry', status: 'REVISED', weakTag: false, notesCount: 1, questionsCount: 1 },
  { id: 'math-8', subjectId: 'math', chapterNo: 8, title: 'Introduction to Trigonometry', status: 'LEARNING', weakTag: true, notesCount: 1, questionsCount: 2 },
  ...
  { id: 'math-10', subjectId: 'math', chapterNo: 10, title: 'Circles & Tangents', status: 'PRACTISED', weakTag: false, notesCount: 1, questionsCount: 1 },
  { id: 'math-11', subjectId: 'math', chapterNo: 11, title: 'Surface Areas and Volumes', status: 'LEARNING', weakTag: true, notesCount: 0, questionsCount: 1 },
  { id: 'math-12', subjectId: 'math', chapterNo: 12, title: 'Statistics (Mean, Median, Mode)', status: 'REVISED', weakTag: false, notesCount: 1, questionsCount: 1 },
  { id: 'math-13', subjectId: 'math', chapterNo: 13, title: 'Probability', status: 'MASTERED', weakTag: false, notesCount: 1, questionsCount: 1 },

  // SCIENCE
  { id: 'sci-1', subjectId: 'science', chapterNo: 1, title: 'Chemical Reactions & Equations', status: 'MASTERED', weakTag: false, notesCount: 1, questionsCount: 1 },
  { id: 'sci-2', subjectId: 'science', chapterNo: 2, title: 'Acids, Bases and Salts', status: 'REVISED', weakTag: false, notesCount: 1, questionsCount: 1 },
  { id: 'sci-3', subjectId: 'science', chapterNo: 3, title: 'Metals and Non-metals', status: 'PRACTISED', weakTag: false, notesCount: 1, questionsCount: 1 },
  { id: 'sci-4', subjectId: 'science', chapterNo: 4, title: 'Carbon and its Compounds', status: 'LEARNING', weakTag: true, notesCount: 1, questionsCount: 2 },
  { id: 'sci-5', subjectId: 'science', chapterNo: 5, title: 'Life Processes (Nutrition & Respiration)', status: 'MASTERED', weakTag: false, notesCount: 1, questionsCount: 2 },
  { id: 'sci-6', subjectId: 'science', chapterNo: 6, title: 'Control and Coordination', status: 'REVISED', weakTag: false, notesCount: 1, questionsCount: 1 },
  { id: 'sci-7', subjectId: 'science', chapterNo: 7, title: 'How do Organisms Reproduce?', status: 'PRACTISED', weakTag: false, notesCount: 1, questionsCount: 1 },
  { id: 'sci-8', subjectId: 'science', chapterNo: 8, title: 'Heredity and Evolution', status: 'LEARNING', weakTag: false, notesCount: 0, questionsCount: 0 },
  { id: 'sci-9', subjectId: 'science', chapterNo: 9, title: 'Light - Reflection and Refraction', status: 'PRACTISED', weakTag: true, notesCount: 1, questionsCount: 2 },
  { id: 'sci-10', subjectId: 'science', chapterNo: 10, title: 'The Human Eye & Colourful World', status: 'REVISED', weakTag: false, notesCount: 1, questionsCount: 1 },
  { id: 'sci-11', subjectId: 'science', chapterNo: 11, title: 'Electricity (Ohm Law, Circuits)', status: 'LEARNING', weakTag: true, notesCount: 1, questionsCount: 2 },
  ...
  { id: 'sci-13', subjectId: 'science', chapterNo: 13, title: 'Our Environment & Ecosystem', status: 'MASTERED', weakTag: false, notesCount: 1, questionsCount: 1 },

  // ENGLISH
  { id: 'eng-1', subjectId: 'english', chapterNo: 1, title: 'A Letter to God', status: 'MASTERED', weakTag: false, notesCount: 1, questionsCount: 1 },
  { id: 'eng-2', subjectId: 'english', chapterNo: 2, title: 'Nelson Mandela: Long Walk to Freedom', status: 'REVISED', weakTag: false, notesCount: 1, questionsCount: 1 },
  { id: 'eng-3', subjectId: 'english', chapterNo: 3, title: 'Two Stories about Flying', status: 'REVISED', weakTag: false, notesCount: 1, questionsCount: 0 },
  { id: 'eng-4', subjectId: 'english', chapterNo: 4, title: 'From the Diary of Anne Frank', status: 'PRACTISED', weakTag: false, notesCount: 1, questionsCount: 1 },
  { id: 'eng-5', subjectId: 'english', chapterNo: 5, title: 'Glimpses of India', status: 'LEARNING', weakTag: false, notesCount: 1, questionsCount: 0 },
  ...
  { id: 'eng-7', subjectId: 'english', chapterNo: 7, title: 'Poetry: Dust of Snow, Fire & Ice, Amanda', status: 'MASTERED', weakTag: false, notesCount: 1, questionsCount: 1 },

  // IT (402)
  { id: 'it-1', subjectId: 'it', chapterNo: 1, title: 'Communication Skills & Self-Management', status: 'MASTERED', weakTag: false, notesCount: 1, questionsCount: 1 },
  { id: 'it-2', subjectId: 'it', chapterNo: 2, title: 'ICT Skills & Digital Documentation (Adv)', status: 'REVISED', weakTag: false, notesCount: 1, questionsCount: 1 },
  { id: 'it-3', subjectId: 'it', chapterNo: 3, title: 'Electronic Spreadsheet (Advanced Formulas)', status: 'PRACTISED', weakTag: true, notesCount: 1, questionsCount: 1 },
  { id: 'it-4', subjectId: 'it', chapterNo: 4, title: 'Database Management System (SQL & Tables)', status: 'LEARNING', weakTag: true, notesCount: 1, questionsCount: 2 },
  { id: 'it-5', subjectId: 'it', chapterNo: 5, title: 'Web Applications & Network Security', status: 'REVISED', weakTag: false, notesCount: 1, questionsCount: 1 },

  // SOCIAL SCIENCE
  { id: 'ss-1', subjectId: 'social_science', chapterNo: 1, title: 'The Rise of Nationalism in Europe', status: 'REVISED', weakTag: false, notesCount: 1, questionsCount: 1 },
  { id: 'ss-2', subjectId: 'social_science', chapterNo: 2, title: 'Nationalism in India (Gandhi & Movements)', status: 'MASTERED', weakTag: false, notesCount: 1, questionsCount: 2 },
  { id: 'ss-3', subjectId: 'social_science', chapterNo: 3, title: 'Resources and Development & Agriculture', status: 'REVISED', weakTag: false, notesCount: 1, questionsCount: 1 },
  { id: 'ss-4', subjectId: 'social_science', chapterNo: 4, title: 'Minerals and Energy Resources', status: 'LEARNING', weakTag: true, notesCount: 1, questionsCount: 1 },
  { id: 'ss-5', subjectId: 'social_science', chapterNo: 5, title: 'Power Sharing and Federalism', status: 'MASTERED', weakTag: false, notesCount: 1, questionsCount: 1 },
  { id: 'ss-6', subjectId: 'social_science', chapterNo: 6, title: 'Money and Credit & Globalisation', status: 'PRACTISED', weakTag: false, notesCount: 1, questionsCount: 1 },
];
...
export const INITIAL_PDFS: PDFDocument[] = [
  ...
  },
  {
    ...
    subjectId: 'math',
    type: 'QUESTION_PAPER',
    title: 'CBSE 2025 Standard Math Board Paper',
    chapterTag: 'Full Syllabus',
    fileSize: 95000,
    addedDate: '2026-10-03',
    lastOpenedDate: '2026-10-06',
    isFavorite: true,
    blob: makeSamplePdfBlob('CBSE 2025 Standard Math Board Paper', 'Mathematics', 'Sections A, B, C, D, E with Case Based Questions.'),
    attemptedCount: 38,
    correctCount: 32,
    redoCount: 6,
    totalQuestions: 38,
  ...
  },
  {
    ...
    subjectId: 'science',
    type: 'QUESTION_PAPER',
    title: 'Carbon Compounds Exemplar & 5-Year PYQs',
    chapterTag: 'Carbon & Compounds',
    fileSize: 74000,
    addedDate: '2026-10-04',
    lastOpenedDate: '2026-10-07',
    isFavorite: false,
